...
class Order{
    ...
    events(order) {
       //Modals
       this.button_closeModalNotice.addEventListener("click", () => this.toggle_ModalNotice_Off());
       this.errorModalCloseButton.addEventListener("click", () => this.toggleModalError_Off());
       this.termsModalCloseButton.addEventListener("click", () => this.toggleModalTerms_Off());
        //Forms
    ...
    toggleModalTerms() {
        this.termsModalOverlay.classList.toggle("modal-overlay--show-modal", true);
        this.termsModal.classList.toggle("modal--box--show", true);
        this.termsModal.classList.toggle("open", true);
        this.termsModal.classList.toggle("close", false);
        this.toggleModalError_Off();
    }

    toggleModalTerms_Off() {
        this.termsModalOverlay.classList.toggle("modal-overlay--show-modal", false);
        this.termsModal.classList.toggle("modal--box--show", false);
        this.termsModal.classList.toggle("open", false);
        this.termsModal.classList.toggle("close", true);
    }


    toggleModalError() {
        this.errorModalOverlay.classList.toggle("modal-overlay--show-modal", true);
        this.errorModal.classList.toggle("modal--box--show", true);
        this.errorModal.classList.toggle("open", true);
        this.errorModal.classList.toggle("close", false);
    }

    toggleModalError_Off() {
        this.errorModalOverlay.classList.toggle("modal-overlay--show-modal", false);
        this.errorModal.classList.toggle("modal--box--show", false);
        this.errorModal.classList.toggle("open", false);
        this.errorModal.classList.toggle("close", true);
    }

    toggle_ModalNotice_Off(){
        this.modalNoticeOverlay.classList.toggle("modal-overlay--show-modal", false);
    }

    toggle_ModalNotice_On(){
        this.modalNoticeOverlay.classList.toggle("modal-overlay--show-modal", true);
    }
